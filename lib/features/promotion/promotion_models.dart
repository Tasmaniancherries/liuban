...
const kPromotionFixtures = <PromotionItem>[
  PromotionItem(
    id: '1',
  ...
  PromotionItem(
    ...
    body: '測試夾具內容：點進後為完整文章區塊，版面可仿公眾號或新聞 App。',
  ),
];

PromotionItem? promotionFixtureById(String id) {
  for (final p in kPromotionFixtures) {
    if (p.id == id) return p;
  }
  return null;
}
