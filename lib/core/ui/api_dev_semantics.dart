...
abstract final class ApiDevSemantics {
  ...
  static String get feedSchoolList => _p(
        "優先載入 GET ${AppConfig.apiPrefix}/feed/school；僅已認證同校；失敗時本校示例。可載入更多。",
      );

  static String get feedFriendsList => _p(
        "優先載入 GET ${AppConfig.apiPrefix}/feed/friends；雙向好友；失敗時好友示例。可載入更多。",
      );
  ...
  static String get feedLoadMoreFailedSnackHint => _p(
        "載入更多為同一動態列表 GET 之分頁請求失敗；已顯示內容保留。可下拉重新整理自第一頁重試。",
      );
  ...
  static String get feedInitialLoadFallbackSnackHint => _p(
        "向伺服器載入第一頁失敗，列表為本地示例；與即時資料不同步，「載入更多」已停用。可下拉重新整理重試。",
      );
  ...
  static String get feedLoadMoreApiErrorSnackHint => _p(
        "載入下一頁失敗，訊息由後端回傳。與第一頁相同之 feed 列表 GET，帶分頁參數。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get feedMockDataBannerSemanticsHint => _p(
        "列表請求失敗後之備援內容，非 GET 回應。重新整理仍打目前分頁對應之 feed 端點。",
      );
  ...
  static String get discardUnsavedLocalFormDialogHint => _p(
        "僅捨棄此頁尚未按主要送出鈕的內容，不會因此呼叫對應 REST（例如登入／註冊／重設／加好友等）。",
      );
  ...
  static String get friendsInbox => _p(
        "優先載入 GET ${AppConfig.apiPrefix}/friends/inbox；失敗時示例資料。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get friendsInboxErrorFallbackSnackHint => _p(
        "GET ${AppConfig.apiPrefix}/friends/inbox 失敗，列表為示例。可下拉重新整理重試。",
      );

  /// [_FriendsInbox] GET 失敗且後端回傳業務訊息、仍顯示例列表時（本體為 [LiubanApiException.message]）。
  static String get friendsInboxGetApiErrorSnackHint => _p(
        "載入收件匣失敗，訊息由後端回傳。預期：GET ${AppConfig.apiPrefix}/friends/inbox。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get friendsInboxMockDataBannerSemanticsHint => _p(
        "收件匣請求失敗後之備援內容。重新整理仍打 GET ${AppConfig.apiPrefix}/friends/inbox。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get dmMockThreadBannerSemanticsHint => _p(
        "對話載入失敗後之備援；與實際 GET 內容不同。",
      );

  static String get promotionsList => _p(
        "優先載入 GET ${AppConfig.apiPrefix}/promotions；失敗時本地示例。",
      );

  /// 推廣列表頁頂部說明（含 API 與 docs 尾註）。
  static String get promotionListBanner => "合作方提供素材，經審核後由留伴平台代為發佈（與廣場用戶帖分流）。"
      "優先載入 GET ${AppConfig.apiPrefix}/promotions；失敗時本地示例。"
  ...
  /// 同上之無障礙 hint。
  static String get promotionListErrorFallbackSnackHint => _p(
        "GET ${AppConfig.apiPrefix}/promotions 失敗，列表為本地示例。可下拉重新整理重試。",
      );

  /// [PromotionListScreen] GET 列表失敗且後端回傳業務訊息、仍顯示例時（本體為 [LiubanApiException.message]）。
  static String get promotionListGetApiErrorSnackHint => _p(
        "載入推廣列表失敗，訊息由後端回傳。預期：GET ${AppConfig.apiPrefix}/promotions。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get promotionListMockDataBannerSemanticsHint => _p(
        "推廣列表請求失敗後之備援內容。重新整理仍打 GET ${AppConfig.apiPrefix}/promotions。",
      );
  ...
  static String get resetPasswordTooShortSnackHint => _p(
        "新密碼長度須符合後端策略（至少 8 字）；尚未送出 complete。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get blockedUsersListErrorFallbackSnackHint => _p(
        "GET ${AppConfig.apiPrefix}/friends/blocks 失敗，列表為示例。可下拉重新整理重試。",
      );

  /// [BlockedUsersScreen] GET 失敗且後端回傳業務訊息、仍顯示例時（本體為 [LiubanApiException.message]）。
  static String get blockedUsersListGetApiErrorSnackHint => _p(
        "載入屏蔽列表失敗，訊息由後端回傳。預期：GET ${AppConfig.apiPrefix}/friends/blocks。",
      );

  static const String blockedUsersMockDataBannerVisibleText =
      "目前為離線示例，與伺服器不同步；下拉可重新整理。";

  static String get blockedUsersMockDataBannerSemanticsHint => _p(
        "屏蔽列表請求失敗後之備援。重新整理仍打 GET ${AppConfig.apiPrefix}/friends/blocks。",
      );

  static String get profileMeGet => _p(
        "GET ${AppConfig.apiPrefix}/auth/me 向伺服器取得個人檔。",
      );

  /// [ProfileScreen] `GET …/auth/me` 失敗、改用占位時之 SnackBar 本文。
  static const String profileMeLoadErrorFallbackMessage = "無法載入個人檔，已顯示占位內容";

  static String get profileMeLoadErrorFallbackSnackHint => _p(
        "GET ${AppConfig.apiPrefix}/auth/me 失敗；畫面為客戶端占位示例。可下拉重新整理。",
      );
  ...
  static String get authMeLoadApiErrorSnackHint => _p(
        "取得目前帳號失敗，訊息由後端回傳。預期：GET ${AppConfig.apiPrefix}/auth/me。",
      );

  static const String profileMeMockDataBannerVisibleText =
      "離線占位資料，非伺服器個人檔；下拉可重新整理。";

  static String get profileMeMockDataBannerSemanticsHint => _p(
        "個人檔請求失敗後之備援。重新整理仍打 GET ${AppConfig.apiPrefix}/auth/me。",
      );
  ...
  static String get changePasswordIncompleteSnackHint => _p(
        "請填齊目前密碼與新密碼；尚未 POST ${AppConfig.apiPrefix}/auth/password。",
      );

  /// [ChangePasswordScreen] 新密碼過短。
  static String get changePasswordTooShortSnackHint => _p(
        "新密碼長度須符合後端策略；尚未送出 POST ${AppConfig.apiPrefix}/auth/password。",
      );

  /// [ChangePasswordScreen] 兩次新密碼不一致。
  static String get changePasswordMismatchSnackHint => _p(
        "兩次新密碼須一致；尚未呼叫 POST ${AppConfig.apiPrefix}/auth/password。",
      );
  ...
  static String get changePasswordApiErrorSnackHint => _p(
        "變更密碼失敗，訊息由後端回傳。預期：POST ${AppConfig.apiPrefix}/auth/password。",
      );

  static String get friendRequestsIncoming => _p(
        "優先載入 GET ${AppConfig.apiPrefix}/friends/requests/incoming；失敗時示例。",
      );

  static String get friendRequestsOutgoing => _p(
        "優先載入 GET ${AppConfig.apiPrefix}/friends/requests/outgoing；失敗時示例。",
      );

  static String get passwordResetRequest => _p(
        "POST ${AppConfig.apiPrefix}/auth/password/reset/request，body：email。",
      );
  ...
  static String get supportMessages => _p(
        "POST ${AppConfig.apiPrefix}/support/messages；示意對話，上線後接通客服。",
      );

  /// [SupportChatScreen] 送出留言 [LiubanApiException]。
  static String get supportSendMessageApiErrorSnackHint => _p(
        "送出客服留言失敗，訊息由後端回傳。預期：POST ${AppConfig.apiPrefix}/support/messages。",
      );
  ...
  static String get addFriendIdEmptySnackHint => _p(
        "請輸入對方自訂 ID；尚未 POST ${AppConfig.apiPrefix}/friends/requests。",
      );
  ...
  static String get addFriendApiErrorSnackHint => _p(
        "送出好友申請失敗，訊息由後端回傳。預期：POST ${AppConfig.apiPrefix}/friends/requests。",
      );
  ...
  static String get friendRequestsMockDataBannerSemanticsHint => _p(
        "此 Tab 的請求失敗後顯示備援列表。",
      );
  ...
  static String get composePostBodyEmptySnackHint => _p(
        "送出須有動態正文；請求 body 含文字欄位。發佈或更新說明見右上角完成按鈕之無障礙提示。",
      );
  ...
  static String get composePostAudienceSchoolConflictSnackHint => _p(
        "audience 與 hide_school 不可如此組合；請調整可見範圍再送出（詳 docs 契約與完成鈕說明）。",
      );
  ...
  static String get loginValidationEmptyFieldsSnackHint => _p(
        "僅客戶端表單檢查；尚未 POST ${AppConfig.apiPrefix}/auth/login。",
      );

  /// [LoginScreen] 登入成功 SnackBar。
  static String get loginSuccessSnackHint => _p(
        "登入成功，已儲存 tokens。POST ${AppConfig.apiPrefix}/auth/login。",
      );

  /// [LoginScreen] 登入 [LiubanApiException]（本體為後端訊息）。
  static String get loginApiErrorSnackHint => _p(
        "登入失敗，訊息由後端回傳。預期：POST ${AppConfig.apiPrefix}/auth/login。",
      );
  ...
  static String get promotionDetailDevNote => _p(
        "優先 GET ${AppConfig.apiPrefix}/promotions/推廣 ID 已編碼；失敗時使用本地或列表快取摘要。",
      );
  ...
  /// 同上之無障礙 hint。
  static String get promotionDetailCacheBannerSemanticsHint => _p(
        "詳情請求失敗後沿用本機或示例之 promotion 摘要；與 GET 回應可能不一致。",
      );
  ...
  static String get feedPostGetApiErrorSnackHint => _p(
        "載入動態失敗，訊息由後端回傳。預期：GET ${AppConfig.apiPrefix}/feed/posts/動態 ID 已編碼。",
      );
  ...
  static String get verificationSyncApiErrorSnackHint => _p(
        "同步審核狀態失敗。預期：GET ${AppConfig.apiPrefix}/auth/me/verification。",
      );
  ...
  static String get settingsLocalUiPreferenceDialogHint => _p(
        "僅更新本機亮暗與語系，不向伺服器提交設定；與 ${AppConfig.apiPrefix} REST 無關。",
      );
  ...
  /// 刪除本人動態對話框第二段。
  static String get deleteOwnPostApiNote => _p(
        "伺服器端：DELETE ${AppConfig.apiPrefix}/feed/posts/動態 ID 已編碼。",
      );

  /// [runFeedReportFlow] 檢舉成功 SnackBar 無障礙 hint。
  static String get feedReportSuccessSnackHint => _p(
        "檢舉已送往伺服器。POST ${AppConfig.apiPrefix}/feed/posts/動態 ID 已編碼/report。",
      );

  /// [runFeedReportFlow] 檢舉失敗 SnackBar（本體為後端訊息）。
  static String get feedReportErrorSnackHint => _p(
        "檢舉請求失敗。路徑：POST ${AppConfig.apiPrefix}/feed/posts/動態 ID 已編碼/report。",
      );

  /// [runBlockUserFlow] 屏蔽成功 SnackBar。
  static String get blockUserSuccessSnackHint => _p(
        "屏蔽已提交。POST ${AppConfig.apiPrefix}/friends/blocks，body：user_id。",
      );

  /// [runBlockUserFlow] 屏蔽失敗 SnackBar（本體為後端訊息）。
  static String get blockUserErrorSnackHint => _p(
        "屏蔽請求失敗。路徑：POST ${AppConfig.apiPrefix}/friends/blocks。",
      );

  /// [runDeleteOwnPostFlow] 刪除成功 SnackBar。
  static String get deleteOwnPostSuccessSnackHint => _p(
        "動態已請求自伺服器刪除。DELETE ${AppConfig.apiPrefix}/feed/posts/動態 ID 已編碼。",
      );

  /// [runDeleteOwnPostFlow] 刪除失敗 SnackBar（本體為後端訊息）。
  static String get deleteOwnPostErrorSnackHint => _p(
        "刪除請求失敗。路徑：DELETE ${AppConfig.apiPrefix}/feed/posts/動態 ID 已編碼。",
      );
  ...
  static String get unblockUserConfirmDialogHint => _p(
        "確認後 POST ${AppConfig.apiPrefix}/friends/blocks/remove，body：user_id。",
      );
  ...
  static String get deepLinkNavigationRejectedHint => _p(
        "屬 App 內連結白名單、長度或導覽限制，非後端依 ${AppConfig.apiPrefix} 直接回傳的錯誤。",
      );
  ...
  static String get shareLinkCopiedSnackHint => _p(
        "連結已複製到剪貼簿，為客戶端操作；未因此呼叫 ${AppConfig.apiPrefix} REST。",
      );
  ...
  static String get openSourceLicensesPageHint => _p(
        "顯示套件授權全文，資料內嵌於 App，非自 ${AppConfig.apiPrefix} 載入。",
      );
}
